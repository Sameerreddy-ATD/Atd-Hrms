...
| Bulk import (User Logins)        | **Bulk add**                                                    | Create-many grid on User Logins; pairs with Bulk edit            |
| Bulk update accounts             | **Bulk edit logins**                                            | Update existing User Logins in a spreadsheet-style grid          |
