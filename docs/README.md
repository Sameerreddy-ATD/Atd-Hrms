...
- Attendance workday core: [Attendance Workday Core](ATTENDANCE_WORKDAY_CORE.md) · [Attendance Core Audit](ATTENDANCE_CORE_AUDIT.md)
- Attendance exceptions / classification: [Exceptions Policy Audit](ATTENDANCE_EXCEPTIONS_POLICY_AUDIT.md)
...
- Security hardening batch (12 Aug 2026): [Security Hardening](SECURITY_HARDENING_2026-08-12.md)
...
| `PRODUCT_NAMING.md`                    | Canonical **AnyTime Diesel Workforce** product name and professional interface terminology    |
