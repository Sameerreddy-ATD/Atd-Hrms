...
Security fixes are maintained on the deployed `version-1` branch. A release is supported only after
its migrations, backend, and frontend have been deployed together and post-deployment verification
has passed.
